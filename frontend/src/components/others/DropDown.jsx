      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute bottom-full z-10 mt-3 w-72 px-4 sm:px-0">
                <div className="">
                  <div className="bg-gray-350 rounded-md">
                    <div>
                      <div className="flex flex-col">
                        ...
                        {micOn ? (
                          <div className="text-white flex items-center px-3 py-3 justify-between bg-gray-800 rounded-full shadow-md">
                            <span className="">
                              <IoMicCircle />
                            </span>

                            <div className="w-36 bg-gray-450 rounded-full h-2 dark:bg-gray-700">
                              <div
                            ...
                            {recordingStatus == "inactive" && (
                              <button
                                className="w-16 h-7 text-xs rounded bg-indigo-700 flex items-center rounded-full"
