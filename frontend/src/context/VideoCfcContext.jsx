...
export const VideoCfcContext = createContext();

export const useVideoCfcContext = () => useContext(VideoCfcContext);

export const VideoCfcProvider = ({ children }) => {
